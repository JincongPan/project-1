...
public class GeneratorServiceEntity {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/rent_system?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"t_car"}); // 需要生成的表
